...
Dark/light color mode is handled through JS, as is E2E encryption; the code for these functions can be found in [index.html](https://github.com/IanWold/PlanningPoker/blob/main/PlanningPoker.Client.Web/wwwroot/index.html). I wrote a [blog post on E2E encryption](https://ian.wold.guru/Posts/end_to_end_encryption_witn_blazor_wasm.html) which covers the implementation used here.
